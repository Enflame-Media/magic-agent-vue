/**
 * Purchases Store for NativeScript Mobile
 *
 * Pinia store managing RevenueCat subscription state including customer info,
 * offerings, and purchase operations. Mirrors the web store for consistency.
 *
 * @example
 * ```typescript
 ...
 * ```
 *
 * @module stores/purchases
 */

import { defineStore } from 'pinia';
import { ref, computed } from 'vue';
import type { CustomerInfo, Offerings } from '@happy-vue/shared';
...
export const usePurchasesStore = defineStore('purchases', () => {
  ...
  /** Whether device can make payments */
  const canMakePayments = ref(true);
  ...
  /**
   * Set whether device can make payments
   */
  function setCanMakePayments(can: boolean) {
    canMakePayments.value = can;
  }
